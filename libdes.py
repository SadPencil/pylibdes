...
__author__ = 'Sad Pencil'
__maintainer__ = 'Sad Pencil'
__email__ = 'sadpencil@outlook.com'
__license__ = "WTFPL"
__version__ = "1.0"

__all__ = ['des_encrypt', 'des_decrypt', 'validate_des_key']
